package com.ksk.mylogintutorial.member.controller;
...
import com.ksk.mylogintutorial.member.service.MemberService;
...
public class MemberController {
	...
	// List(Show all user except for 'admin')
	@RequestMapping("/listForm")
	public ModelAndView memList() {
		ModelAndView mav = new ModelAndView();

		List<Member> memList = service.memberList();

		mav.addObject("List", memList);
		mav.setViewName("/member/listForm");
